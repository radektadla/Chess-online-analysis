...
1) Data uploading from csv file and checking the first few records to understand the dataset's structure
2) Data cleaning (stripping text, converting to lowercase, replacing values, checking for duplicates and NaNs)
3) Data analysis - answering 4 analytical questions:
